...
## 2023-11-02 | lines | [bsky](https://bsky.app/profile/ikashnitsky.phd/post/) | [fosstodon](https://fosstodon.org/@ikashnitsky/) 
{{< mastodon "https://fosstodon.org/@ikashnitsky/" >}}


```{r index, echo=FALSE}
library(fs)
file_copy(path = "README.html", new_path = "index.html", overwrite = TRUE)
```
